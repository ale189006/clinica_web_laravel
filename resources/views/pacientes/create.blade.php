...
<div class="container-fluid px-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1"><i class="bi bi-person-plus text-primary me-2"></i>Nuevo Paciente</h2>
                    <p class="text-muted mb-0">Complete los datos para registrar un nuevo paciente</p>
                </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-xl-8">
            <form method="POST" action="{{ route('pacientes.store') }}" id="formNuevoPaciente">
                @csrf
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg px-4">
                                <i class="bi bi-check-circle me-2"></i>Registrar Paciente
                            </button>
                        </div>
                    </div>
                </div>
