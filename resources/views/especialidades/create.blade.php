...
<div class="container-fluid px-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1"><i class="bi bi-star-fill text-primary me-2"></i>Nueva Especialidad</h2>
                    <p class="text-muted mb-0">Complete los datos para registrar una nueva especialidad médica</p>
                </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-xl-8">
            <form method="POST" action="{{ route('especialidades.store') }}" id="formNuevaEspecialidad">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <ul class="small text-muted mb-0 ps-3">
                                    ...
                                    <li>Una vez creada, podrá asignarse a doctores</li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg px-4">
                                <i class="bi bi-check-circle me-2"></i>Registrar Especialidad
                            </button>
                        </div>
                    </div>
                </div>
